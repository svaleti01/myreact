...
const OnlineBankingEnrollmentViewContent = ({ }) => {
  ...
  return (
    ...
    <>
      ...
      {/* <FieldGroup widths={[6, 6]}>
        <Tooltip text='Click here go next page' position='center'>
          <button>Next</button>
        </Tooltip>
        <Tooltip text='Click here Cancel' position='right'>
...
export default OnlineBankingEnrollmentViewContent
