...
const PrivacyPDFDownloadContent = () => {
    return (
        <Document>
            <Page size="A4" style={styles.body}>
              <Text style={ styles.title }>Online Banking Terms And Conditions</Text>
              <Text style={ styles.subtitle }>Online Banking Terms And Conditions FOR THE USE OF WWW.ORIENTALBANK.COM (“PAGE”)</Text>
              ...
              <Text style={ styles.text }>
                PLEASE READ THESE Online Banking Terms And Conditions CAREFULLY. BY ENTERING TO THE PAGE AND TO ANY AREA THEREOF YOU AGREE 
                TO COMPLY WITH THESE Online Banking Terms And Conditions AND, AS APPLICABLE, THOSE ESTABLISHED FOR EACH AREA OF THE PAGE. 
                ORIENTAL BANK RESERVES THE RIGHT TO AMEND, TEMPORARILY SUSPEND OR TERMINATE THESE Online Banking Terms And Conditions AT 
                ANY TIME AT OUR ABSOLUTE DISCRETION. YOU ARE RESPONSIBLE FOR KEEPING UP TO DATE WITH THE TERMS IN EFFECT 
                FROM TIME TO TIME EACH TIME YOU ACCESS THE PAGE. IF YOU DO NOT AGREE WITH THESE Online Banking Terms And Conditions OR WITH 
              ...
              <Text style={ styles.text }>
                ...
                ANY WARRANTY. BY THESE Online Banking Terms And Conditions YOU WAIVE ANY WARRANTY OR CONDITION WITH RESPECT TO THE PAGE, 
              ...
              <Text style={ styles.text }>
                Any communication related to these Online Banking Terms And Conditions or to the use of the Page shall be in writing 
              ...
              <Text style={ styles.text }>
                ...
                relationships established by these Online Banking Terms And Conditions or otherwise arising in relation 
                ...
                those jurisdictions in which the effectiveness of these Online Banking Terms And Conditions is not 
                ...
                or regulation. Performance of these Online Banking Terms And Conditions by Oriental is subject to the laws 
                ...
                in relation to said use. If any of these Online Banking Terms And Conditions were declared void or unenforceable 
                ...
                A print version of these Online Banking Terms And Conditions and of any communication given electronically 
...
export default PrivacyPDFDownloadContent
